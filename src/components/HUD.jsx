...
const HUD = () => {
  return (
    <div className='fixed bottom-8 right-6 z-50 flex flex-col gap-2 font-["Arial_Black"]'>
      ...
      {/* Armor */}
      <div className='flex items-center gap-2'>
        <span className='text-blue-400 text-xs tracking-widest font-bold w-14 text-right'>ARMOR</span>
        <div className='w-36 h-4 bg-[#1a1a1a] border border-[#555] relative overflow-hidden'>
